...
/* deepMergeProposta trata uma chave com valor `undefined` explícito como
   "sobrescreve com vazio" (Object.keys inclui a chave mesmo com valor
   undefined) — sem isso, `campo: condição ? {...} : undefined` apagaria
   o boilerplate rico do default em vez de preservá-lo quando o legado
   não tinha aquele dado. */
